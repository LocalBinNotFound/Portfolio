            ...
            <div className="grid grid-cols-1 sm:grid-cols-12">
                <motion.div initial={ {opacity : 0, scale: 0.5} }
                    ...
                    <h1 className="text-white mb-4 text-4xl sm:text-5xl lg:text-8xl lg:leading-normal font-extrabold">
                        ...
                        <TypeAnimation
                            sequence={ [
                                'Junjie', 1000, 'Full Stack Developer', 1000, 'Mobile Developer', 1000, 'Gamer', 1000
                            ] }
                            wrapper="span"
                            speed={ 50 }
                            repeat={ Infinity }
                    ...
                    <p className="text-[#ADB7BE] text-base sm:text-lg mb-6 lg:text-xl">
                        I am a web developer, mobile developer, game enthusiast, content creator.
                    </p>
                    <div>
                        <button
                        ...
                        <button
                            ...
                            <span
                                className="block bg-[#121212] hover:bg-slate-800 rounded-full px-5 py-2">Download CV</span>
                        </button>
                    </div>
                </motion.div>
                <motion.div initial={ {opacity : 0, scale: 0.5} }
