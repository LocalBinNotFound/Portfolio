            ...
            <div className="grid grid-cols-1 sm:grid-cols-12">
                <motion.div initial={ {opacity : 0, scale: 0.5} }
                    ...
                    <p className="text-textColor text-base sm:text-lg mb-6 lg:text-xl">
                        Crafting innovative and scalable solutions with over 2 years in software development.
                        Dedicated to delivering high-quality, user-centered designs and applications, I blend
                        technical skill with creativity to produce engaging experiences in web and mobile
                        environments. Let's bring your next project to life!
                    </p>
                    <div>
                        <button
                        ...
                        <button
                            ...
                            <span
                                className="block bg-navBarColor hover:bg-slate-800 rounded-full px-5 py-2">Download CV</span>
                        </button>
                    </div>
                </motion.div>
                <motion.div initial={ {opacity : 0, scale: 0.5} }
